...
export const metadata: Metadata = {
  title: "Nosotros",
  description: "Conocé la historia y valores de Patagonia Vértice, desarrolladora inmobiliaria con más de 15 años en Neuquén y la Patagonia.",
};
...
const valores = [
  {
    icon: Eye,
    titulo: "Visión",
    descripcion: "Anticipamos las necesidades del mercado patagónico y actuamos antes que nadie.",
  },
  {
    icon: Handshake,
    titulo: "Compromiso",
    descripcion: "Cumplimos lo prometido en cada etapa, desde la preventa hasta la entrega.",
  },
  {
    icon: Shield,
    titulo: "Confianza",
    descripcion: "Construimos relaciones sólidas con inversores, clientes y comunidades.",
  },
  {
    icon: Star,
    titulo: "Excelencia",
    descripcion: "Estándares de calidad que superan las expectativas del mercado regional.",
  },
  {
    icon: Lightbulb,
    titulo: "Innovación",
    descripcion: "Incorporamos tecnología y diseño contemporáneo en cada proyecto.",
  },
  {
    icon: Users,
    titulo: "Equipo",
    descripcion: "Un grupo humano comprometido con el desarrollo de la Patagonia.",
  },
];
    ...
    <>
      ...
      <div className="relative bg-tierra pt-40 pb-32 overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, rgba(28,26,23,0.6), rgba(28,26,23,0.95))" }} />
        </div>
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center gap-4 mb-6">
            <div className="h-px w-10 bg-dorado" />
            <span className="font-body text-dorado text-[11px] tracking-[0.3em] uppercase">Patagonia Vértice</span>
          </div>
          <h1
          ...
          <p className="font-body text-crema/40 text-base leading-relaxed max-w-xl">
            Somos una desarrolladora y constructora neuquina en pleno crecimiento,
            con proyectos propios en Neuquén y la Patagonia.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="h-px w-10 bg-dorado" />
                <span className="font-body text-dorado text-[11px] tracking-[0.25em] uppercase">Nuestra historia</span>
              </div>
              <h2
              ...
              <div className="space-y-5 font-body text-tierra/55 text-sm leading-relaxed">
                <p>
                  Patagonia Vértice nació del profundo conocimiento del territorio neuquino
                  y de la convicción de que la Patagonia merece desarrollos inmobiliarios
                  a la altura de su paisaje y su gente.
                </p>
                <p>
                  Con más de 15 años de trayectoria, combinamos experiencia en construcción
                  con una visión integral del mercado regional. Cada proyecto responde a la
                  demanda real de familias e inversores que eligen vivir o apostar al sur.
                </p>
                <p>
                  Desde lotes en entornos naturales hasta complejos residenciales en el corazón
                  de Neuquén Capital, nuestros desarrollos generan valor real y duradero.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-4 mb-6">
              <div className="h-px w-10 bg-dorado" />
              <span className="font-body text-dorado text-[11px] tracking-[0.25em] uppercase">Lo que nos mueve</span>
              <div className="h-px w-10 bg-dorado" />
            </div>
            <h2
      ...
      <section className="py-24 bg-tierra">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          <div className="flex items-center justify-center gap-4 mb-6">
            <div className="h-px w-10 bg-dorado" />
            <span className="font-body text-dorado text-[11px] tracking-[0.25em] uppercase">¿Listo para invertir?</span>
            <div className="h-px w-10 bg-dorado" />
          </div>
          <h2
