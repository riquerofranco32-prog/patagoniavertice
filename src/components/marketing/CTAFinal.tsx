...
export default function CTAFinal() {
  return (
    <section className="relative overflow-hidden flex flex-col lg:flex-row min-h-[600px]">
      ...
      <div className="relative lg:w-[55%] bg-tierra py-28 lg:py-36 px-8 lg:px-20 flex flex-col justify-center overflow-hidden">
        ...
        <div
          ...
          style={{ fontSize: "clamp(7rem, 18vw, 14rem)", letterSpacing: "-0.05em" }}
          aria-hidden="true"
        >
          invertí
        </div>
        ...
        <div className="relative">
          ...
          >
            ...
            Cada proyecto es una oportunidad única en una región que no para de expandirse.
          </motion.p>
          ...
          >
            <a
              ...
              className="group inline-flex items-center justify-center gap-3 px-9 py-4 bg-[#25D366] text-white font-body text-[11px] tracking-[0.15em] font-semibold uppercase hover:bg-[#20bd5a] transition-colors duration-300"
            >
            ...
            <Link
              href="/contacto"
              className="inline-flex items-center justify-center gap-2 px-9 py-4 border border-crema/15 text-crema/60 font-body text-[11px] tracking-[0.15em] font-medium uppercase hover:border-dorado hover:text-dorado transition-all duration-300"
            >
      ...
      >
        <img
          ...
          alt="Patagonia — paisaje de inversión"
          className="absolute inset-0 w-full h-full object-cover"
        />
        {/* Gradient overlay blending into left panel */}
        <div
          className="absolute inset-0"
          style={{ background: "linear-gradient(to right, rgba(28,25,22,0.6) 0%, rgba(28,25,22,0.15) 50%, transparent 100%)" }}
        />
        {/* Bottom overlay */}
        <div
          className="absolute inset-0"
          style={{ background: "linear-gradient(to top, rgba(28,25,22,0.5) 0%, transparent 60%)" }}
        />
