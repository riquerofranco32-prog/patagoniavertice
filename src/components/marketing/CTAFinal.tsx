        ...
        <div className="relative">
          ...
          >
            ...
            <Link
              href="/contacto"
              onClick={spawnRipple}
              className="relative overflow-hidden inline-flex items-center justify-center gap-2 px-9 py-4 border border-crema/15 text-crema/60 font-body text-[11px] tracking-[0.15em] font-medium uppercase hover:border-dorado hover:text-dorado transition-all duration-300"
            >
