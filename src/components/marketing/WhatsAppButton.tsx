    ...
    >
      ...
      <AnimatePresence>
        {hovered && (
          ...
          >
            <div className="bg-tierra text-crema font-body text-[11px] tracking-[0.1em] whitespace-nowrap px-4 py-2.5 relative">
              <span>Consultanos sin cargo</span>
              {/* Arrow */}
              <span className="absolute right-[-6px] top-1/2 -translate-y-1/2 border-y-4 border-y-transparent border-l-[6px] border-l-tierra" />
            </div>
          </motion.div>
        )}
      </AnimatePresence>
