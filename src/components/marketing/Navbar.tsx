      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between h-20">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          {links.map((l) => (
            <Link
              key={l.href}
              href={l.href}
              className="font-body text-crema/70 text-xs tracking-widest hover:text-crema transition-colors duration-300"
            >
              {l.label}
            </Link>
          ))}
        ...
        <div className="hidden lg:flex items-center gap-5">
          <a
            ...
            className="font-body text-crema/60 text-xs tracking-wider hover:text-[#25D366] transition-colors flex items-center gap-2"
          >
          ...
          <Link
            href="/contacto"
            className="font-body text-tierra text-xs tracking-widest uppercase bg-dorado px-5 py-2.5 hover:bg-dorado/90 transition-colors duration-300"
          >
            Consultar Ahora
          </Link>
        </div>
        ...
        <nav className="flex flex-col gap-5 px-6 pt-6">
          {links.map((l) => (
            <Link
              ...
              className="font-body text-crema/70 text-xs tracking-widest uppercase hover:text-dorado transition-colors"
            >
              {l.label}
            </Link>
          ))}
          <Link
            href="/contacto"
            onClick={() => setOpen(false)}
            className="mt-2 font-body text-tierra text-xs tracking-widest uppercase bg-dorado px-5 py-3 text-center hover:bg-dorado/90 transition-colors"
          >
            Consultar Ahora
          </Link>
        </nav>
