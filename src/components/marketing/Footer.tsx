    ...
    <footer className="bg-[#141210] text-crema">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <div className="mb-5">
              ...
              <span className="font-display text-dorado text-sm font-light tracking-[0.35em] uppercase block">
                Vértice
              </span>
            </div>
            ...
            <div className="flex gap-4">
              {[
                ...
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-9 h-9 border border-crema/10 flex items-center justify-center text-crema/40 hover:border-dorado hover:text-dorado transition-colors"
                >
            ...
            <nav className="flex flex-col gap-3">
              {[
                ...
                <Link
                  key={l.href}
                  href={l.href}
                  className="font-body text-crema/40 text-sm hover:text-dorado transition-colors"
                >
                  {l.label}
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 font-body text-crema/40 text-sm">
              ...
              >
                <svg className="w-4 h-4 text-dorado/60 shrink-0 fill-current" viewBox="0 0 24 24">
        ...
        <div className="border-t border-crema/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <Link
            href="/admin"
            className="font-body text-crema/10 text-xs hover:text-crema/30 transition-colors"
          >
            Acceso Admin
          </Link>
        </div>
