      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="flex gap-3">
              {socials.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-9 h-9 border border-crema/10 flex items-center justify-center text-crema/40 hover:border-dorado hover:text-dorado hover:scale-110 transition-all duration-200"
                >
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              {["En ejecución", "En preventa", "Entregados", "Lotes"].map((l) => (
                <Link key={l} href="/proyectos" className="font-body text-crema/40 text-sm hover:text-dorado transition-colors duration-200">
                  {l}
                </Link>
              ))}
            </nav>
        ...
        <div className="border-t border-crema/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <Link href="/admin" className="font-body text-crema/10 text-xs hover:text-crema/30 transition-colors duration-200">
            Acceso Admin
          </Link>
        </div>
      </div>
